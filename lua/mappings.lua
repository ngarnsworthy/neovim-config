...
end, { desc = "Goto and fix next error" })
map("n", "<leader>gs", function() vim.lsp.buf.code_action() end, { desc = "Shows code actions" })
map("n", "<leader>gn", function() vim.diagnostic.goto_next() end, { desc = "Goes to next code error" })
